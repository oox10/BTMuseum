...
<html lang="zh-Hant-TW">
	<head>
	    ...
	    <?php 
		  $print_html = isset($this->vars['server']['data']['print']['html']) ? $this->vars['server']['data']['print']['html'] : '';
		  $print_page = isset($this->vars['server']['data']['print']['page']) ? $this->vars['server']['data']['print']['page'] : [];	  
		  $page = 0;
		?>
